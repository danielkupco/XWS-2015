...
public class BankaService extends Service {
    ...
    public final static QName SERVICE = new QName("http://xws/tim7/banka", "BankaService");
    public final static QName BankaPort = new QName("http://xws/tim7/banka", "BankaPort");
    static {
        URL url = null;
        try {
            ...
            java.util.logging.Logger.getLogger(BankaService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/Programiranje/Eclipse workspaces/XWS/XWS_Tim7/WEB-INF/wsdl/banka.wsdl");
        }
        WSDL_LOCATION = url;
    }
